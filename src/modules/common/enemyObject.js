...
export const EnemyObjectTick = (object,delta,clipping,keys,Callbacks,collisionList,state) =>
{
    //console.log("EnemyObjectTick",object,delta,clipping,keys,Callbacks,collisionList,state)
